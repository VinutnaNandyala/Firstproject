...
%TFS% workfold "$/DFSSACommission/Working/Concierge UI-Release branch/" "C:\Program Files (x86)\Jenkins\workspace\%JOB_NAME%" /map /login:cts\804175,vinuthna@35cse /collection:https://cygnus.cognizant.com/tfs/dfsventuresingaporeptelimited /workspace:"Hudson-%JOB_NAME%-MASTER"
%TFS% get "$/DFSSACommission/Working/Concierge UI-Release branch/" -force -recursive -noprompt /login:cts\804175,vinuthna@35cse
